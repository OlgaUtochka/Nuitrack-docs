...
1.  As a first step, download Unity [from the official website](https://unity3d.com/get-unity/download).

### Note
*To ensure stable operation of a project, we recommend you to use Unity 5.5.0f3.*
